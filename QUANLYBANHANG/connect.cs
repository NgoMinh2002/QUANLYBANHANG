   ...
   public class connect 
    {
        ...
        public static string strcon = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=""D:\Thự tập tốt nghiệp- Ngô Minh Anh - 202190495\QL_BanHang\QUANLYBANHANG\QUANLYBANHANG\QL_hanghoa.mdf"";Integrated Security=True;Connect Timeout=30";
        ...
        // kiểm tra xóa đối tượng đang sử dụng
        ...
        // check khóa
        public static bool checkKhoa(string sql)
        {
            Open();
